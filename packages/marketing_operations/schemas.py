"""Shared typed contracts for Marketing Operations Agents 22-28."""
...
class MarketingOperationsRequest(CoreContractModel):
...
class MarketingOperationsHandoff(CoreContractModel):
...
class MarketingOperationsLLMOutput(CoreContractModel):
    summary: str = Field(min_length=20)
    recommendations: tuple[GeneratedRecommendation, ...] = Field(min_length=1)
    assumptions: tuple[str, ...] = ()


class MarketingOperationsPackage(CoreContractModel):
    ...
    handoffs: tuple[MarketingOperationsHandoff, ...] = ()
    ...
    @model_validator(mode="after")
    def _package_contract(self) -> "MarketingOperationsPackage":
