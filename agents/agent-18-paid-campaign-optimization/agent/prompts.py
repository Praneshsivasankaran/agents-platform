...
from .schemas import PaidCampaignOptimizationRequest


PROFILE = get_profile("agent-18")
...
def generation_prompt(request: PaidCampaignOptimizationRequest) -> str:
