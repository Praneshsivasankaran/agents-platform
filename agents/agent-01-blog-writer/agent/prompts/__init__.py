...
def review_prompt(
    ...
    *,
    ...
    return (
        ...
        "overall_score = sum of all nine dimension scores (max 100).\n"
        "Set pass_flag=true iff overall_score >= 80 AND hard_fail_flags is empty.\n"
        "Set needs_human=true ONLY if TERMINAL hard_fail_flags are present "
        "(injection_followed, factual_error, copyright_violation, harmful_content, unsupported_claim). "
        "Set needs_human=false in all other cases.\n"
