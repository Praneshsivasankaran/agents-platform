"""LangGraph workflow for Agent 15."""
...
from .schemas import KeywordResearchPackage, KeywordResearchRequest


def build_graph(cfg: dict, llm: LLMProvider, tel: Telemetry) -> Any:
    """Compile Agent 15's cloud-neutral LangGraph workflow."""
    return build_digital_marketing_graph(
        PROFILE,
        cfg,
        llm,
        tel,
        request_cls=KeywordResearchRequest,
        package_cls=KeywordResearchPackage,
    )
