...
from .schemas import ConversionRateOptimizationRequest


PROFILE = get_profile("agent-20")
...
def generation_prompt(request: ConversionRateOptimizationRequest) -> str:
