...
def test_request_coerces_funnel_fields() -> None:
    request = AgentRequest(
        conversion_goal="Increase demo submissions",
        target_audience="RevOps leaders",
        page_notes="Users drop near proof section.",
        funnel_stages=[{"stage": "Visitors", "count": 1000}, {"stage": "Submissions", "count": 45}],
    )
    assert request.funnel_stages[0].stage == "Visitors"
