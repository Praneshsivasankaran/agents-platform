"""LangGraph workflow for Agent 09."""
...
from .schemas import AudienceSegmentationPackage, AudienceSegmentationRequest


def build_graph(cfg: dict, llm: LLMProvider, tel: Telemetry) -> Any:
    """Compile Agent 09's cloud-neutral LangGraph workflow."""
    return build_demand_generation_graph(
        PROFILE,
        cfg,
        llm,
        tel,
        request_cls=AudienceSegmentationRequest,
        package_cls=AudienceSegmentationPackage,
    )
