"""LangGraph workflow for Agent 14."""
...
from .schemas import ConversionAnalysisPackage, ConversionAnalysisRequest


def build_graph(cfg: dict, llm: LLMProvider, tel: Telemetry) -> Any:
    """Compile Agent 14's cloud-neutral LangGraph workflow."""
    return build_demand_generation_graph(
        PROFILE,
        cfg,
        llm,
        tel,
        request_cls=ConversionAnalysisRequest,
        package_cls=ConversionAnalysisPackage,
    )
