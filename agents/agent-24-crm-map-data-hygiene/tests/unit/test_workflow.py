...
SAMPLE_INPUTS: dict[str, dict[str, Any]] = {
    ...
    "agent-24": {
        ...
        "sample_summary": "Summary-only sample: 8% missing country; no record-level rows supplied",
        "issue_summary": "Country value completeness summary supplied",
        "lifecycle_stages": ["Subscriber", "MQL", "SQL"],
        "owner_context": "Data steward: RevOps admin",
        "source_notes": "Supplied data dictionary and field summary.",
    },
    "agent-25": {
