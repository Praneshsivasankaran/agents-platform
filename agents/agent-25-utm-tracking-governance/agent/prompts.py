...
from .schemas import UTMTrackingGovernanceRequest


PROFILE = get_profile("agent-25")
...
def generation_prompt(request: UTMTrackingGovernanceRequest) -> str:
