...
from .schemas import MultiChannelCampaignPlanningRequest


PROFILE = get_profile("agent-19")
...
def generation_prompt(request: MultiChannelCampaignPlanningRequest) -> str:
