"""LangGraph workflow for Agent 26."""
...
from .schemas import LeadRoutingSLADesignPackage, LeadRoutingSLADesignRequest


def build_graph(cfg: dict, llm: LLMProvider, tel: Telemetry) -> Any:
    """Compile Agent 26's cloud-neutral LangGraph workflow."""
    return build_marketing_operations_graph(
        PROFILE,
        cfg,
        llm,
        tel,
        request_cls=LeadRoutingSLADesignRequest,
        package_cls=LeadRoutingSLADesignPackage,
    )
